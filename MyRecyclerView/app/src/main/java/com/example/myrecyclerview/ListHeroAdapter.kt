...
//        val valName:TextView = itemView.findViewById(R.id.val_item_name)
//        val valDesc:TextView = itemView.findViewById(R.id.val_item_desc)
//    }
...
//        return ListViewHolder(view)
    ...
    override fun onBindViewHolder(holder: ListViewHolder, position: Int) {
        ...
        holder.binding.valItemName.text = name
        holder.binding.valItemDesc.text = description
